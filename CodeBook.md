...
The raw data is sourced from the Human Activity Recognition Using Smartphones Dataset v1.0.

Details of the authors of this data set are:
...
Acknowledge for the use of the original dataset - 
